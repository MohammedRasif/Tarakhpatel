  ...
  return (
    <div className='bg-black container mx-auto py-10 pt-20'>
      <div className='lg:flex  justify-between '>
        ...
        <p className='text-gray-300 lg:w-1/2 lg:pl-10 px lg:text-start text-center pt-2'>Your wearables track steps. Your lab tests live in portals. Your doctor has notes you can't access. And every app gives cookie-cutter advice. The result? A fragmented health picture causing confusion, generic advice and little support to understand progress or take confident next steps.</p>
      </div>
