...
function Cadensa() {
  return (
     <div className="lg:py-10 lg:pt-20 pb-20">
      <div className="container mx-auto py-10 pt-20 text-center max-w-5xl px-4">
      ...
      <div className="relative flex items-center justify-center px-4">
        <div className="relative w-full lg:h-[50vh] h-[40vh] overflow-hidden rounded-3xl">
        ...
        <div className="container mx-auto absolute lg:-bottom-28 -bottom-56">
          <Animatedborder />
        </div>
      </div>
    </div>
